...
Для автоматизированных тестов автоматически, либо вручную формируется иерархия вызовов. Автоматически иерерхия формируется только для `vanessa automation`. Просмотр иерархии вызовов доступен в диаграмме.
