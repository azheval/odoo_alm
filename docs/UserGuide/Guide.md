...
Модуль реализует работу с проектами. Это типовой модуль Odoo дополненный данными конфигурационных единиц модуля ALM Base.
...
Указать даты начала и окончания плановых сроков выполнения. Зависимость от других задач.

![Модули ALM](/docs/UserGuide/images/032.png)

Поддерживаются различные формы отображения задач.

![Модули ALM](/docs/UserGuide/images/022.png)

Для вида "Диаграмма Ганта" поддерживается краткая расшифровка задачи. Сроки выполнения задачи можно изменять перетаскиванием "границ" задачи.

![Модули ALM](/docs/UserGuide/images/033.png)
