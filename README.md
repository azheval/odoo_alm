...
Этот репозиторий содержит Коллекция модулей Odoo 19, разработанных для управления жизненным циклом приложений - Application Lifecycle Management (ALM).
...
| ALM Requirement | Module for managing application requirements. | 19.0.1.0.1 |
...
The following diagram shows the container architecture of the ALM system within Odoo.

![diagram](/docs/images/c4_containers.png)
